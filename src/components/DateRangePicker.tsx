...
export default function DateRangePicker() {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        onClick={handleReset}
        className="px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg transition-colors h-fit"
      >
        Reset
      </button>
